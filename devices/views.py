    ...
    devices_json = [
        {
            ...
            "login_method_label": d.get_login_method_display(),
            "login_username": d.login_username or "",
            "login_command": d.login_command,
...
def _export_row(device, switches):
    ...
    return [
        ...
        port,
        switch_name,
        "" if device.is_switch else device.get_login_method_display(),
        "" if device.is_switch else (device.login_username or ""),
